...
class OneActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("ConstraintLayoutDrawTime", "One ConstraintLayout create time: $duration ns")
        val createTimeTextView = TextView(this).apply {
            id = View.generateViewId()
            text = "One ConstraintLayout create time: $duration ns"
            layoutParams = ConstraintLayout.LayoutParams(
        ...
        rootLayout.viewTreeObserver.addOnPreDrawListener(object :
            ...
            override fun onPreDraw(): Boolean {
                ...
                Log.d(
                    ...
                    "One ConstraintLayout draw time: $totalDuration ns"
                )

                // 화면에 표시되는 시간 텍스트뷰 추가
                val drawTimeTextView = TextView(this@OneActivity).apply {
                    id = View.generateViewId()
                    text = "One ConstraintLayout draw time: $totalDuration ns"
                    layoutParams = ConstraintLayout.LayoutParams(
                        ConstraintLayout.LayoutParams.WRAP_CONTENT,
                        ConstraintLayout.LayoutParams.WRAP_CONTENT
                    )
