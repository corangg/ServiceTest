...
class OneActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("FrameLayoutDrawTime", "One FrameLayout create time: $duration ns")
        currentLayout.addView(TextView(this).apply {
            text = "One FrameLayout create time: $duration ns"
            layoutParams = FrameLayout.LayoutParams(
        ...
        rootLayout.viewTreeObserver.addOnPreDrawListener(object :
            ...
            override fun onPreDraw(): Boolean {
                ...
                Log.d(
                    "FrameLayoutDrawTime",
                    "One FrameLayout draw time: $totalDuration ns"
                )

                // 화면에 표시되는 시간 텍스트뷰 추가
                currentLayout.addView(TextView(this@OneActivity).apply {
                    text = "One FrameLayout draw time: $totalDuration ns"
                    layoutParams = FrameLayout.LayoutParams(
                        FrameLayout.LayoutParams.WRAP_CONTENT,
                        FrameLayout.LayoutParams.WRAP_CONTENT
                    ).apply {
